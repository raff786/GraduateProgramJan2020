...
public class employeeBinaryFileDAO implements DataAccessObject<Employee> {
	...
	public employeeBinaryFileDAO(String fileName) {
		...
		//read all the data from the file and load into collection map
		readMapFromFile();
	}
	//read the data from file and add it to the map Shared
	private void readMapFromFile() {
		//ObjectInputStream: Read Objects from Binary File inputStream
	...
	private void writeMapToFile() {
		//objectOutputStream: write binary object in Serialized format in 
		//FileOutPutStream: write Binary Objects to Files
		//File: File objects will refer to the file to be updated/created if not present
